...
public class TagRegistration {
    public static class Blocks {
        ...
        private static TagKey<Block> tag(String name) {
            return TagKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(Cluttered.MODID, name));
        }
    }
    ...
    public static class Items {
        ...
        private static TagKey<Item> tag(String name) {
            return TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Cluttered.MODID, name));
        }
    }
}
