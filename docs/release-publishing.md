...
For this port, the first automated release after the three manual uploads is:

```properties
mod_version=3.0.3-26.1.2-0.1.3-fabric-unofficial
```
...
Future small fixes should become `0.1.4`, `0.1.5`, and so on. Use `0.2.0` when the port gets a larger feature or compatibility update.
...
```text
v3.0.3-26.1.2-0.1.3-fabric-unofficial
```
...
```text
Cluttered 3.0.3 - 26.1.2 Fabric 0.1.3 (Unofficial Port)
```
